...
- [**Inventory Management**](/example/1.x/inventory-management) - Track stock across locations
- [**Pricing Strategies**](/example/1.x/pricing) - Multi-currency & customer group pricing
- [**Sites & Markets**](/example/1.x/sites-architecture) - Multi-site setup
- [**Blueprint System**](/example/1.x/blueprint-system) - Customize product fields
