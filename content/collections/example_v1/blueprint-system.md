...
- [**Product Architecture**](/example/1.x/product-architecture) - Understand product/variant structure
- [**Development**](/example/1.x/development) - Build custom fields and blueprints
- [**API Reference**](/example/1.x/api) - Programmatic blueprint access
