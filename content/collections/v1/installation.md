...
1. [**Product Architecture**](/v1/product-architecture) - Understand the product/variant system
2. [**Sites & Markets**](/v1/sites-architecture) - Configure multi-site setup
3. [**Blueprint System**](/v1/blueprint-system) - Customize content fields
4. [**Development**](/v1/development) - Start building with Cartino
